...
export function Result() {
  ...
  const [result] = useState(() => Math.random() > 0.5);
  const [confidence] = useState(() => 75 + Math.floor(Math.random() * 20));
  ...
  const statusConfig = result
    ? {
        ...
        reasons: [
          "Garbage spill detected outside dustbin",
          "Overflow condition identified",
    ...
    : {
        ...
        reasons: [
          "Dustbin within normal capacity",
          "No spill detected",
          "Area appears clean",
        ],
      };
            ...
            >
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <div className="font-medium text-foreground">DMC-Vision v2.1</div>
                </div>
              </div>
            </motion.div>
          </motion.div>
